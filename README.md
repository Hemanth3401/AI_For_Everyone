# AI_For_Everyone
 Uplod your Ai Program here andlets make a huge collection of them.

# Hacktoberfest !!!

### Get yourself free goodies by just writing a AI Program!

Say hi to the world in any language of your choice used in Artifical Intenglience!
...
You can get your own fork/copy of [Hacktoberfest](https://github.com/Hemanth987/AI_For_Everyone.git) by using the <kbd><b>Fork</b></kbd></a> button or clicking [this](https://github.com/Hemanth987/AI_For_Everyone.git).
...
by checking our `Help Wanted` issues and creating [pull requests](https://github.com/Hemanth987/AI_For_Everyone/pulls).
...
https://github.com/Hemanth987/AI_For_Everyone.git
...
```
git clone https://github.com/Hemanth987/AI_For_Everyone.git
```
...
```
git remote add upstream https://github.com/Hemanth987/AI_For_Everyone.git
```
...
# Hurray!! You have just done one of your hacktoberfest challenge.

Wait for yor Pull request to get accepted 